...
class Tan final : public UnaryOP{
    public:
    explicit Tan(BaseExpr* operand) : UnaryOP(operand) {}
...
class Ln final : public UnaryOP{
    public:
    explicit Ln(BaseExpr* operand) : UnaryOP(operand) {}
    ~Ln() override = default;
...
class Exp final : public UnaryOP{
    public:
    explicit Exp(BaseExpr* operand) : UnaryOP (operand){}
